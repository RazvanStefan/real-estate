                        ...
                        <div class="row">
                            <div class="col s6">
                                <div class="box indigo white-text p-30">
                                    ...
                                    <span class="truncate uppercase bold font-18">Anunturi</span>
                            ...
                            <div class="col s6">
                                <div class="box indigo white-text p-30">
                                    ...
                                    <span class="truncate uppercase bold font-18">Mesaje</span>
                        ...
                        <div class="row">
                            <div class="col s6">
                                <div class="box indigo white-text p-20">
                                    ...
                                    <span class="truncate uppercase bold">Adaugate recent</span>
                                </div>
                            ...
                            <div class="col s6">
                                <div class="box indigo white-text p-20">
                                    ...
                                    <span class="truncate uppercase bold">Emailuri recente</span>
                                </div>
                                <div class="box-content">
