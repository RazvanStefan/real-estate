        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s12 m4 card">
                    ...
                    <h2 class="sidebar-title">Cauta anunt</h2>
                    ...
                    <form class="sidebar-search" action="{{ route('search')}}" method="GET">
                        ...
                        <div class="searchbar">
                            <div class="input-field col s12">
                                ...
                                <label for="autocomplete-input-sidebar">Oras</label>
                            </div>
                            ...
                            <div class="input-field col s12">
                                <select name="bathroom" class="browser-default">
                                    <option value="" disabled selected>Bai</option>
                            ...
                            <div class="input-field col s12">
                                ...
                                <label for="minprice">Pret min.</label>
                            </div>
                            ...
                            <div class="input-field col s12">
                                ...
                                <label for="minarea">Suprafata min.</label>
                            </div>
    
                            <div class="input-field col s12">
                                <input type="number" name="maxarea" id="maxarea" class="custominputbox">
                                <label for="maxarea">Suprafata Max.</label>
                            </div>
